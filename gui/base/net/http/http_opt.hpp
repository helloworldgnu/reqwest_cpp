...
enum class HttpErrorKind {
  ...
  /// pattern. New [`std::io::ErrorKind`]s might be added in the future for some
  /// of those.
  Other,
  /// Any I/O error from the standard library that's not part of this list.
  ///
  /// Errors that are `Uncategorized` now may move to a different or a new
  /// [`std::io::ErrorKind`] variant in the future. It is not recommended to
  /// match an error against `Uncategorized`; use a wildcard match (`_`)
  /// instead.
  Uncategorized,
  HttpTimeOutErr,
  HttpBuilderErr,
