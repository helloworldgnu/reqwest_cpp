...
ClientBuilder *ClientBuilder::http2_initial_connection_window_size(uint32_t *size){
    RETURN_SELF_NULL_THROW(ffi::client_builder_http2_initial_connection_window_size(
        this, size))} ClientBuilder *ClientBuilder::http2_initial_connection_window_size(uint32_t size){
...
ClientBuilder *ClientBuilder::http2_initial_stream_window_size(uint32_t *size){
    RETURN_SELF_NULL_THROW(ffi::client_builder_http2_initial_stream_window_size(
        this, size))} ClientBuilder *ClientBuilder::http2_initial_stream_window_size(uint32_t size){
...
ClientBuilder *ClientBuilder::http2_max_frame_size(uint32_t *size){
    RETURN_SELF_NULL_THROW(ffi::client_builder_http2_max_frame_size(
        this, size))} ClientBuilder *ClientBuilder::http2_max_frame_size(uint32_t size){
...
ClientBuilder *ClientBuilder::pool_idle_timeout(const uint64_t *millisecond){
    RETURN_SELF_NULL_THROW(ffi::client_builder_pool_idle_timeout(
        this, millisecond))} ClientBuilder *ClientBuilder::pool_idle_timeout(const uint64_t millisecond){
...
ClientBuilder *ClientBuilder::resolve_to_addrs(const std::string &domain, std::vector<const char *> &socket_addr_array){
    RETURN_SELF_NULL_THROW(ffi::client_builder_resolve_to_addrs(this, domain.c_str(), &socket_addr_array[0],
                                                                socket_addr_array.size()))} ClientBuilder
...
ClientBuilder *ClientBuilder::tcp_keepalive(const uint64_t *millisecond){
    RETURN_SELF_NULL_THROW(ffi::client_builder_tcp_keepalive(
        this, millisecond))} ClientBuilder *ClientBuilder::tcp_keepalive(const uint64_t millisecond){
...
RequestBuilder *RequestBuilder::basic_auth(const std::string &username, const std::string &password){
    RETURN_SELF_NULL_THROW(ffi::request_builder_basic_auth(this, username.c_str(), password.c_str()))} RequestBuilder
    *RequestBuilder::bearer_auth(const std::string &token){RETURN_SELF_NULL_THROW(ffi::request_builder_bearer_auth(
        this, token.c_str()))} RequestBuilder *RequestBuilder::body(const std::vector<uint8_t> &bytes){
        RETURN_SELF_NULL_THROW(ffi::request_builder_body_bytes(this, &bytes[0], bytes.size()))} RequestBuilder
        *RequestBuilder::file_body(const std::string &file_path){RETURN_SELF_NULL_THROW(ffi::request_builder_body_file(
            this, file_path.c_str()))} RequestBuilder *RequestBuilder::body(const std::string &str){
            RETURN_SELF_NULL_THROW(ffi::request_builder_body_string(this, str.c_str()))}

RequestBuilder *RequestBuilder::form(const std::vector<Pair> &pairs){RETURN_SELF_NULL_THROW(ffi::request_builder_form(
    this, &pairs[0], pairs.size()))} RequestBuilder *RequestBuilder::form(const std::initializer_list<Pair> &pairs)
{
...
RequestBuilder *RequestBuilder::json(const std::vector<Pair> &pairs){RETURN_SELF_NULL_THROW(ffi::request_builder_json(
    this, &pairs[0], pairs.size()))} RequestBuilder *RequestBuilder::json(const std::initializer_list<Pair> &pairs)
{
    std::vector<Pair> tmp(pairs);
...
RequestBuilder *RequestBuilder::query(const std::vector<Pair> &querys){
    RETURN_SELF_NULL_THROW(ffi::request_builder_query(this, &querys[0], querys.size()))} RequestBuilder
