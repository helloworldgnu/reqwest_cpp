...
ClientBuilder *ClientBuilder::New(){RETURN_SELF_NULL_THROW(ffi::new_client_builder())}
...
ClientBuilder *ClientBuilder::default_headers(HeaderMap *headerMap){RETURN_SELF_NULL_THROW(ffi::client_builder_default_headers(this, headerMap))}
...
ClientBuilder *ClientBuilder::http09_responses(){RETURN_SELF_NULL_THROW(ffi::client_builder_http09_responses(this))}

ClientBuilder *ClientBuilder::http1_allow_obsolete_multiline_headers_in_responses(bool val){
    RETURN_SELF_NULL_THROW(ffi::client_builder_http1_allow_obsolete_multiline_headers_in_responses(this, val))}

ClientBuilder *ClientBuilder::http1_only(){RETURN_SELF_NULL_THROW(ffi::client_builder_http1_only(this))}

ClientBuilder *ClientBuilder::http1_title_case_headers(){RETURN_SELF_NULL_THROW(ffi::client_builder_http1_title_case_headers(this))}

ClientBuilder *ClientBuilder::http2_adaptive_window(bool enable){RETURN_SELF_NULL_THROW(ffi::client_builder_http2_adaptive_window(this, enable))}

ClientBuilder *ClientBuilder::http2_initial_connection_window_size(uint32_t *size){RETURN_SELF_NULL_THROW(
    ffi::client_builder_http2_initial_connection_window_size(this, size))} ClientBuilder *ClientBuilder::http2_initial_connection_window_size(uint32_t size){
    RETURN_SELF_NULL_THROW(ffi::client_builder_http2_initial_connection_window_size(this, &size))}

ClientBuilder *ClientBuilder::http2_initial_stream_window_size(uint32_t *size){RETURN_SELF_NULL_THROW(
    ffi::client_builder_http2_initial_stream_window_size(this, size))} ClientBuilder *ClientBuilder::http2_initial_stream_window_size(uint32_t size){
...
ClientBuilder *ClientBuilder::http2_max_frame_size(uint32_t *size){
    RETURN_SELF_NULL_THROW(ffi::client_builder_http2_max_frame_size(this, size))} ClientBuilder *ClientBuilder::http2_max_frame_size(uint32_t size){
    RETURN_SELF_NULL_THROW(ffi::client_builder_http2_max_frame_size(this, &size))}

ClientBuilder *ClientBuilder::http2_prior_knowledge(){RETURN_SELF_NULL_THROW(ffi::client_builder_http2_prior_knowledge(this))}

ClientBuilder *ClientBuilder::https_only(bool enable){RETURN_SELF_NULL_THROW(ffi::client_builder_https_only(this, enable))}

ClientBuilder *ClientBuilder::local_address(const std::string &local_address){RETURN_SELF_NULL_THROW(ffi::client_builder_local_address(this, local_address.c_str()))}

ClientBuilder *ClientBuilder::max_tls_version(const std::string &version){RETURN_SELF_NULL_THROW(ffi::client_builder_max_tls_version(this, version.c_str()))}

ClientBuilder *ClientBuilder::min_tls_version(const std::string &version){RETURN_SELF_NULL_THROW(ffi::client_builder_min_tls_version(this, version.c_str()))}

ClientBuilder *ClientBuilder::no_trust_dns(){RETURN_SELF_NULL_THROW(ffi::client_builder_no_trust_dns(this))}

ClientBuilder *ClientBuilder::pool_idle_timeout(const uint64_t *millisecond){
    RETURN_SELF_NULL_THROW(ffi::client_builder_pool_idle_timeout(this, millisecond))} ClientBuilder *ClientBuilder::pool_idle_timeout(const uint64_t millisecond){
    RETURN_SELF_NULL_THROW(ffi::client_builder_pool_idle_timeout(this, &millisecond))}

ClientBuilder *ClientBuilder::pool_max_idle_per_host(uintptr_t max){RETURN_SELF_NULL_THROW(ffi::client_builder_pool_max_idle_per_host(this, max))}

ClientBuilder *ClientBuilder::proxy(Proxy *proxy){RETURN_SELF_NULL_THROW(ffi::client_builder_proxy(this, proxy))}

ClientBuilder *ClientBuilder::redirect(size_t max){RETURN_SELF_NULL_THROW(ffi::client_builder_redirect(this, max))}

ClientBuilder *ClientBuilder::referer(bool enable){RETURN_SELF_NULL_THROW(ffi::client_builder_referer(this, enable))}

ClientBuilder *ClientBuilder::resolve(const std::string &domain,
                                      const std::string &socket_addr){RETURN_SELF_NULL_THROW(ffi::client_builder_resolve(this, domain.c_str(), socket_addr.c_str()))}

ClientBuilder *ClientBuilder::resolve_to_addrs(const std::string &domain, std::vector<const char *> &socket_addr_array){
    RETURN_SELF_NULL_THROW(ffi::client_builder_resolve_to_addrs(this, domain.c_str(), &socket_addr_array[0], socket_addr_array.size()))} ClientBuilder
...
ClientBuilder *ClientBuilder::tcp_keepalive(const uint64_t *millisecond){
    RETURN_SELF_NULL_THROW(ffi::client_builder_tcp_keepalive(this, millisecond))} ClientBuilder *ClientBuilder::tcp_keepalive(const uint64_t millisecond){
    RETURN_SELF_NULL_THROW(ffi::client_builder_tcp_keepalive(this, &millisecond))}

ClientBuilder *ClientBuilder::tcp_nodelay(bool enable){RETURN_SELF_NULL_THROW(ffi::client_builder_tcp_nodelay(this, enable))}

ClientBuilder *ClientBuilder::timeout(const uint64_t *millisecond){RETURN_SELF_NULL_THROW(ffi::client_builder_timeout(this, millisecond))}

ClientBuilder *ClientBuilder::timeout(const uint64_t millisecond){RETURN_SELF_NULL_THROW(ffi::client_builder_timeout(this, &millisecond))}

ClientBuilder *ClientBuilder::connect_timeout(const uint64_t *millisecond){RETURN_SELF_NULL_THROW(ffi::client_builder_connect_timeout(this, millisecond))}
...
ClientBuilder *ClientBuilder::tls_sni(bool tls_sni){RETURN_SELF_NULL_THROW(ffi::client_builder_tls_sni(this, tls_sni))}
...
RequestBuilder *Client::head(const std::string &url){RETURN_SELF_NULL_THROW(ffi::client_head(this, url.c_str()))}

RequestBuilder *Client::patch(const std::string &url){RETURN_SELF_NULL_THROW(ffi::client_patch(this, url.c_str()))}

RequestBuilder *Client::post(const std::string &url){RETURN_SELF_NULL_THROW(ffi::client_post(this, url.c_str()))}

RequestBuilder *Client::put(const std::string &url){RETURN_SELF_NULL_THROW(ffi::client_put(this, url.c_str()))}

RequestBuilder *Client::request(const std::string &method, const std::string &url){RETURN_SELF_NULL_THROW(ffi::client_request(this, method.c_str(), url.c_str()))}
...
RequestBuilder *RequestBuilder::bearer_auth(const std::string &token){RETURN_SELF_NULL_THROW(ffi::request_builder_bearer_auth(this, token.c_str()))}
...
RequestBuilder *RequestBuilder::form(const std::vector<Pair> &pairs){RETURN_SELF_NULL_THROW(ffi::request_builder_form(this, &pairs[0], pairs.size()))}
...
RequestBuilder *RequestBuilder::query(const std::vector<Pair> &querys){
    RETURN_SELF_NULL_THROW(ffi::request_builder_query(this, &querys[0],
                                                      querys.size()))} RequestBuilder *RequestBuilder::query(const std::initializer_list<Pair> &querys)
{
...
RequestBuilder *RequestBuilder::timeout(uint64_t millisecond){RETURN_SELF_NULL_THROW(ffi::request_builder_timeout(this, millisecond))}

RequestBuilder *RequestBuilder::try_clone(){RETURN_SELF_NULL_THROW(ffi::request_builder_try_clone(this))}
...
std::string Response::remote_addr(){RETURN_STRING_AND_FREE(ffi::response_remote_addr(this))}
...
std::string Response::url(){RETURN_STRING_AND_FREE(ffi::response_url(this))}

std::string Response::version(){RETURN_STRING_AND_FREE(ffi::response_version(this))}
...
std::string HeaderMap::get(const std::string &key) const {RETURN_STRING_AND_FREE(ffi::header_map_get(this, key.c_str()))}

std::string HeaderMap::get_all(const std::string &key) const {RETURN_STRING_AND_FREE(ffi::header_map_get_all(this, key.c_str()))}

std::string HeaderMap::keys() const {RETURN_STRING_AND_FREE(ffi::header_map_keys(this))}

std::string HeaderMap::values() const {RETURN_STRING_AND_FREE(ffi::header_map_values(this))}
